...
ic1 = createSprite(1050,200,20,20);
ic1.shapeColor = "yellow"
ic1.velocityY = 10;

//medical supplies white
ic2 = createSprite(934,336,20,20);
...
ic7.shapeColor = "navy blue"
ic7.velocityY = 7.5;

ic8 = createSprite(366,356,20,20);
ic8.shapeColor = "navy blue"
ic8.velocityY = 11;
...
b2 = createSprite(315,350,60,60)
b2.shapeColor = "#4fc3f7"

b3 = createSprite(943,176,150,30)
b3.shapeColor = "#4fc3f7"

b4 = createSprite(930,375,130,20)
...
t2.shapeColor = "#4fc3f7"
    ...
    t3 = createSprite(930,250,100,30);
t3.shapeColor = "#4fc3f7"
    t4 = createSprite(930,265,50,45);
